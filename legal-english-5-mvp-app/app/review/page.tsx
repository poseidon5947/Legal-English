...
const COPY: Record<Locale, { back: string; eyebrow: string; title: string; lead: string; start: string; steps: Step[] }> = {
  ...
  es: {
    ...
    steps: [
      ...
      { title: "Crea una cuenta nueva", body: "Regístrate con tu propio correo. La prueba de siete días empieza de inmediato y queda persistida. El código de verificación llega a la bandeja Alpha, el mismo lugar que ocupará Resend en producción.", icon: "shield" },
